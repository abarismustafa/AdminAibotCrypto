                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">MANAGE ECOMMERCE CATEGORIES</h4>
                                        <Link to='/ecommerce/category/add' className="btn btn-primary">Add</Link>
                                    </div>
