...
import FilterMatchingBonusReport from "./FilterMatchingBonusReport";

function MatchingBonusReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Matching Bonus Income Report",
        title_2: 'Matching Bonus Income Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Matching Bonus Income Report List</h4>
                                    </div>
...
export default MatchingBonusReport