...
import FilterEarningCycleBonusreport from "./FilterEarningCycleBonusreport";

function EarningCycleBonusReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Earning Cycle Bonus Income Report",
        title_2: 'Earning Cycle Bonus Income Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Earning Cycle Bonus Income Report List</h4>
                                    </div>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Commission Per Subscriber</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Total Team</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Total Income</th>
                                                </tr>
                                            </thead>
                                            <tbody>
...
export default EarningCycleBonusReport