...
import FilterSocietyIncomeReport from "./FilterSocietyIncomeReport";

function SocietyIncomeReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Society Income Report",
        title_2: 'Society Income Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Society Income Report List</h4>
                                    </div>
...
export default SocietyIncomeReport