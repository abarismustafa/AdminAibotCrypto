...
import FilterLevelIncomeReport from "./FilterLevelIncomeReport";

function LevelIncomeReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Level Income Report",
        title_2: 'Level Income Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Level Income Report List</h4>
                                    </div>
