...
import FilterFastAchivmntIncomeReport from "./FilterFastAchivmntIncomeReport";

function FastAcheivementBonusReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Fast Achievement Income Report",
        title_2: 'Fast Achievement Income Report',
        path_2: ``
    };
    ...
    return (
        <>
            ...
            <FilterFastAchivmntIncomeReport />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Fast Achievement Income Report List</h4>
                                    </div>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Income</th>
...
export default FastAcheivementBonusReport