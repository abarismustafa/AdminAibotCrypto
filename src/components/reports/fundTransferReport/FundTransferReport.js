...
import { getFilteredFundTransferReportData, getFundTransferReportData, getPackagePurchaseData } from "../../../api/login/Login";
import FilterFundTransferReport from "./FilterFundTransferReport";

function FundTransferReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Fund Transfer Report",
        title_2: 'Fund Transfer Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Fund Transfer Report List</h4>
                                    </div>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Transaction Date/Time</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Transaction Type</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>From Member Code</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>From Member Name</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>To Member Code</th>
                                                    <th style={{ width: '150px', }}>To Member Name</th>
                                                </tr>
                                            </thead>
                                            <tbody>
