...
// import { getFilteredFundTransferReportData } from '../../../api/login/Login';

function FilterFundTransferReport({ getFIlteredData }) {
                ...
                <div className="card-body p-0">
                    <div className="table-responsive active-projects style-1">
                        <div className="tbl-caption tbl-caption-2">
                            <h4 className="heading mb-0 p-2">FILTER All Fund Transfer Report</h4>
                        </div>
...
export default FilterFundTransferReport