...
function PackagePurchaseReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Package Purchase Report",
        title_2: 'Package Purchase Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Package Purchase Report List</h4>
                                        {/* <Link
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Customer Name</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Customer Code</th>
...
export default PackagePurchaseReport