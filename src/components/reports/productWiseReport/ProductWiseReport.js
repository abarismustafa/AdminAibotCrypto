...
import ProductWiseReportFilter from "./ProductWiseReportFilter";

function ProductWiseReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Reports",
        title_2: 'Product Wise Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Product Wise Report List</h4>
                                        {/* <Link
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>PCode</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Product</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Quantity</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Total Amount</th>
