...
import FilterReferralComssionReport from "./FilterReferralComssionReport";

function ReferrlCommissionReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Referral Commission Report",
        title_2: 'Referral Commission Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Referral Commission Report List</h4>
                                    </div>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Trx</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Contest Name</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Transacted</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Amount</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Post Balance</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Detail</th>
                                                </tr>
                                            </thead>
                                            <tbody>
...
export default ReferrlCommissionReport