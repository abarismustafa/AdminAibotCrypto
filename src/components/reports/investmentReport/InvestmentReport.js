...
import FilterInvestmentReport from "./FilterInvestmentReport";

function InvestmentReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Investment Report",
        title_2: 'Investment Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Investment Report List</h4>
                                    </div>
