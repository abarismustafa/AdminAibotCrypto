...
function MainWalletReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Main Wallet Report",
        title_2: 'Main Wallet Report',
        path_2: ``
    };
                ...
                <div className="card">
                    <div className="card-body p-0">
                        <div className="table-responsive active-projects style-1">
                            <h5>Balance: <CiWallet /> <span style={{ color: 'green', fontWeight: '700' }}>350.00</span></h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Main Wallet Report List</h4>
                                        {/* <Link
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Type</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Remark</th>
