...
import FilterBinaryComissionReport from "./FilterBinaryComissionReport";

function BinaryComissionReport() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Binary Commission Report",
        title_2: 'Binary Commission Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Binary Commission Report List</h4>
                                    </div>
...
export default BinaryComissionReport