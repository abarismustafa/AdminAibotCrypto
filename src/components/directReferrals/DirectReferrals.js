...
import DirectReferralFilter from "./DirectReferralFilter";

function DirectReferrals() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Direct Referrals",
        title_2: 'Direct Referrals',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Direct Team List</h4>
                                        {/* <Link
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Registration Date</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Activation Date</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Package</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Position</th>
