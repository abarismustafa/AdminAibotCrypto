...
import DistributorSearchFilter from "./DistributorSearchFilter";

function DistributorSearch() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Distributor Search",
        title_2: 'List Distributor Search',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Distributor List</h4>
                                        {/* <Link
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px', textAlign: 'center' }}>User Login</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Name</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Package</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Mobile</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>BTC Address</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Sponsor Detail</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>DOJ</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Password</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Trans Password</th>
