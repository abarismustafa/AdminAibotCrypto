...
import { deleteAchievement, getAchievementData } from "../../../api/login/Login";
import { useEffect, useState } from "react";

function ListAchievement() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "All Achievement",
        title_2: 'List All Achievement',
        path_2: ``
    };
    ...
    const getListData = async (page) => {
        setLoading(true)
        try {
            const res = await getAchievementData(page, count)
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">All Achievement List</h4>
                                        <Link
                                                    ...
                                                    return <tr role="row" key={item?._id}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex">
                                                                <Link to={`/achievement/edit/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1">
