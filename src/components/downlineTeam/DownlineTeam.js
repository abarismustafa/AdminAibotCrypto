...
import DownlineTeamFIlter from "./DownlineTeamFIlter";

function DownlineTeam() {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Downline Team",
        title_2: 'Downline Team',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Downline Team List</h4>
                                        {/* <Link
