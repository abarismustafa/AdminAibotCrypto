...
import {  deleteAccSalesInvoiceTypeById,  getAccSalesInvoiceTypeByPage} from '../../../../api/login/Login'
import { message } from 'antd'
import MasterList from './masterList/MasterList'
function SalesInvoiceTr() {
    const breadCrumbsTitle = {
        title_1: "master",
        title_2: "List Of Sales Invoice",
    }
