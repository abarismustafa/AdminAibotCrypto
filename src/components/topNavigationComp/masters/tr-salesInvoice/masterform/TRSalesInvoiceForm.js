...
const TRSalesInvoiceForm = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Transaction",
        title_2: 'Add Sales Bill',
        path_2: ``
    };
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0 p-2">Add Sales Bill
                                    </h4>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="salesAccount">Sales A/c</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                            name="salesAccount"
...
export default TRSalesInvoiceForm