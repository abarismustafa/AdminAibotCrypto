                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0">Manage Forex Signals</h4>
                                        <div>
                                            <Link className="btn btn-primary btn-sm" to="/add-ext/forex/signal" role="button" aria-controls="offcanvasExample">+ Add New</Link>
                                                ...
                                                return <tr role="row" className="odd">
                                                    ...
                                                    <td>
                                                        <div className="d-flex">
                                                            <Link to={`/edit-ext/forex/signal/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1"><i className="fa fa-pencil" /></Link>
                                                            <Popconfirm
                                                                title="Delete !"
