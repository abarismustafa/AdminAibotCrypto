                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0">Manage Forex Durations</h4>
                                        <div>
                                            <Link className="btn btn-primary btn-sm" to="/add-ext/forex/duration" role="button" aria-controls="offcanvasExample">+ Add New</Link>
