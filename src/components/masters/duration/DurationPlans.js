...
import {  deleteAccTaxMasterById,  getAccTaxMasterByPage} from '../../../api/login/Login'
import { message } from 'antd'
import MasterList from './masterList/MasterList'
function DurationPlans() {
    const breadCrumbsTitle = {
        // title_1: "master",
        title_2: "Manage Forex Durations",
    }
