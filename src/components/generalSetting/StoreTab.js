                            ...
                            <form className="tbl-captionn">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col-lg-12 mb-4">
                                        <label for="exampleFormControlInput1" class="form-label">Digital Store Status</label>
                                    ...
                                    <div className="col-lg-12 mb-4">
                                        <label for="exampleFormControlInput1" class="form-label">Default Sales Commission (optional, in percentage)</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                            placeholder="Enter Default Sales Commission"
                                        />
                                    </div>
                                    ...
                                    <div className="col-lg-12 mb-4">
                                        <label for="exampleFormControlInput1" class="form-label">Vendor Status (SaaS)</label>
                                        <div class="button-group">
                                            <button
                                                type="button"
                                                style={{
